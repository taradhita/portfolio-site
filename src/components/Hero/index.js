            ...
            <div className="md:w-1/3 lg:w-1/3 sm:w-full px-4 py-4 md:py-8 lg:py-16">
              <div className="flex flex-wrap justify-center">
                <div className="w-10/12 sm:w-8/12">
                  <Image src="/image/profile.jpg" width="800" height="800" alt="..." className="rounded-full max-w-full h-auto align-middle border-4 border-solid border-primary-800 dark:border-primary-200 shadow-[5px_5px_0px_0px_rgba(31,41,55)] dark:shadow-[5px_5px_0px_0px_rgba(229,231,235)]"></Image>
                </div>
              </div>
            </div>
