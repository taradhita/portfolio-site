    ...
    <section id="contact" className="bg-white dark:bg-gray-800 py-10 md:py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="#" className="space-y-8">
          <div>
              <label for="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 font-mono">Your email</label>
          ...
          <div>
              <label for="subject" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 font-mono">Subject</label>
          ...
          <div className="sm:col-span-2">
              <label for="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 font-mono">Your message</label>
